        ...
        # ghost not captured
            ...
            for p in self.legalPositions:
                ...
                if emissionModel[trueDistance] > 0:
                    # update the agent's belief distribution
...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # ghost not captured
            ...
            for particle in self.particles:
                ...
                if emissionModel[trueDistance] > 0:
                    weight[particle] += emissionModel[trueDistance]
            # if all particles receive 0 weight, resample uniformly
            if weight.totalCount() == 0:
                self.initializeUniformly(gameState)
            # otherwise, resample using the helper method
            else:
                newParticles = []
                for particle in self.particles:
    ...
    def elapseTime(self, gameState):
        ...
        newParticles = []
        for particle in self.particles:
            beliefs = self.getPositionDistribution(self.setGhostPosition(gameState, particle))
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        "*** YOUR CODE HERE ***"
        self.particles = []
        # generate permutations of legal ghost positions and shuffle them
    ...
    def observeState(self, gameState):
        ...
        ** Remember ** We store particles as tuples, but to edit a specific particle,
        ...
        # find the indices of captured ghosts
        for i in range(self.numGhosts):
