...
def getNNXorData(fileString ="datasets/xor.data.txt", limit=100000 ):
    ...
    classNNList = {'false' : [1,0], 'true': [0, 1]}
...
def buildExamplesFromXorData(size=100):
    ...
    #print "xor data list : " + str(xorDataTrainList)
    #print len(xorDataTrainList)
    random.shuffle(xorDataTrainList)
    moreXorDataTrainList = xorDataTrainList * 10
    random.shuffle(moreXorDataTrainList)
    xorDataTestList = moreXorDataTrainList[0:size]
